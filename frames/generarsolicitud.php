                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="txtdescripcion2" onkeyup="valdescripcionpublic()" class="form-control" rows="7" placeholder="Brida tu detalle"></textarea>
                    </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="box box-widget widget-user-2">
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#">Servicio Elegido <span class="pull-right badge bg-blue">Reparación de Tables</span></a></li>
                <li><a href="#">Titulo de Pedido<span class="pull-right badge bg-aqua">Necesito Reparar mi computadora ya que pantalla no prende</span></a></li>
                <li><a href="#">Precio Aproximado <span class="pull-right badge bg-green">500.00 soles a más</span></a></li>
                <li><a href="#">Tipo de Asistencia <span class="pull-right badge bg-red">Remota</span></a></li>
              </ul>
            </div>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" onclick='registrardata()'>GO - VAMOS!</button>
      </div>
    </div>
  </div>
</div>
